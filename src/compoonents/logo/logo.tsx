...
export const Logo = forwardRef<HTMLDivElement, LogoProps>(
  (
    ...
    const singleLogo = (
      <Box alt="Single logo" component="img" src="/logo_white.png" width="100%" height="100%" />
    );

    const fullLogo = (
      <Box width="100%" display='flex' flexDirection='row' alignItems="start" >
        <img alt="" src="/logo_white.png" width={60} />
        <Typography pl={2} textAlign="start" color='white' fontWeight={700} fontSize={21} >
