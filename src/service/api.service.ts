...
class APIService {
  ...
  static login = (payload: any) =>
    axiosInstance.post("/auth/login", payload).then((res: any) => res);

  static forgotPassword = (payload: any) =>
    axiosInstance
      .post("/auth/send-password-reset", payload)
      .then((res: any) => res);

  static sendOTP = (payload: any) =>
    axiosInstance.post("/auth/resend-otp", payload).then((res: any) => res);

  static resetPassword = (payload: any) =>
    axiosInstance.put("/auth/reset-password", payload).then((res: any) => res);

  static verifyOTP = (payload: any) =>
    axiosInstance.post("/auth/verify", payload).then((res: any) => res);

  static getProfile = () =>
    axiosInstance.get("/admins/current/profile").then((res: any) => res);
  ...
  static getActivities = (page: number) =>
    axiosInstance
      .get(`/admins/activities/all?page=${page}`)
      .then((res: any) => res);
  ...
  static updateBanner = (payload: any, id: string) =>
    axiosInstance
      .put(`/admins/banners/${id}/update`, payload)
      .then((res: any) => res);

  static removeBanner = (id: string) =>
    axiosInstance
      .put(`/admins/banners/${id}/delete`, {})
      .then((res: any) => res);

  static updateSocial = (payload: any, id: string) =>
    axiosInstance
      .put(`/admins/socials/${id}/update`, payload)
      .then((res: any) => res);

  static removeSocial = (id: string) =>
    axiosInstance
      .put(`/admins/socials/${id}/delete`, {})
      .then((res: any) => res);
  ...
  static suspendAdmin = (id: any) =>
    axiosInstance
      .post(`/admins/admin/${id}/suspend`, {})
      .then((res: any) => res);

  static pardonAdmin = (id: any) =>
    axiosInstance
      .post(`/admins/admin/${id}/pardon`, {})
      .then((res: any) => res);

  static deleteAdmin = (id: any) =>
    axiosInstance
      .post(`/admins/admin/${id}/delete`, {})
      .then((res: any) => res);

  static manageContact = (payload: any) =>
    axiosInstance
      .post("/admins/settings/manage", payload)
      .then((res: any) => res);
  ...
  static updateService = (payload: any, id: any) =>
    axiosInstance
      .post(`/services/${id}/update`, payload)
      .then((res: any) => res);

  static deleteService = (id: any) =>
    axiosInstance.post(`/services/${id}/delete`, {}).then((res: any) => res);

  static addProgram = (payload: any) =>
    axiosInstance.post("/programs/save", payload).then((res: any) => res);

  static updateProgram = (id: string, payload: any) =>
    axiosInstance
      .put(`/programs/${id}/update`, payload)
      .then((res: any) => res);

  static deleteProgram = (id: any) =>
    axiosInstance.put(`/programs/${id}/delete`, {}).then((res: any) => res);

  static addEvent = (payload: any) =>
    axiosInstance.post("/events/save", payload).then((res: any) => res);

  static updateEvent = (id: string, payload: any) =>
    axiosInstance.put(`/events/${id}/update`, payload).then((res: any) => res);

  static deleteEvent = (id: any) =>
    axiosInstance.put(`/events/${id}/delete`, {}).then((res: any) => res);
}
